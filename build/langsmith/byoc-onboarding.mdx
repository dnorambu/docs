...
If you are moving from an existing LangSmith Cloud or [self-hosted](/langsmith/self-hosted) instance, users, roles, datasets, prompts, experiments, annotation queues, automation rules, and dashboards can be copied over. Traces <b>cannot be migrated today</b>.
