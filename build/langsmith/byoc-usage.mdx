...
The LangSmith UI handles this automatically: it routes to the correct data plane based on the workspace you have selected. This section is relevant for your own client applications and direct API calls.
...
- **Data plane**: belongs to an organization. It represents physical separation of data. An organization can have several data planes, each in its own AWS account and region.
